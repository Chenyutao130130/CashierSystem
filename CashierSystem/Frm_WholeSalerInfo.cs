...
namespace CashierSystem
{
    public partial class Frm_WholeSalerInfo : Form
    {
        ...
        public static Frm_WholeSalerInfo Create(List<string> tags = null)
        {
            ...
            if (_form == null)
            {
                _form = new Frm_WholeSalerInfo();  //供应商
                _Tags = tags;
            }
            else
            {
        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            if (entityId == int.MaxValue)
            {
                ...
                wholeSalerInfo.SupName = txtSupName.Text.Trim();        //供货商名
                wholeSalerInfo.Management = txtManagement.Text.Trim();  //负责人
                wholeSalerInfo.TelePhone = txtPhone.Text.Trim();        //联系电话
                wholeSalerInfo.AddressInfo = txtAddress.Text.Trim();    //地址
                wholeSalerInfo.Remark = txtRemark.Text.Trim();          //备注
            ...
            else
            {
                ...
                var isSuccess = DataManager.WholeSalerInfoBLL.Edit(wholeSalerInfo);  //更新
                if (!isSuccess)
                {
                    MessageBox.Show("操作失败!");
                }
