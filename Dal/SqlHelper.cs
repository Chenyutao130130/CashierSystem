...
namespace Dal
{
    public class SqlHelper
    {
     ...
     //Provider = Microsoft.Jet.OLEDB.4.0; Data Source = 文件路径; HDR=YES
        private static string connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sales.mdb" + ";Jet OLEDB:Database Password=" + "kn666";// @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Sales.mdb;Persist Security Info=False";
