...
namespace Dal
{
    public  class OrderInfoDal:BaseDal<OrderInfo>
    {
        ...
        public DataTable GetTodayDataTable(DateTime startTime=new DateTime(),DateTime endTime = new DateTime(), Dictionary<string, string> dic = null)
        {
            ...
            DateTime DateTime = DateTime.Now.Date;  //设置筛选条件！！！！！！！！！！！！！！！！！！！！！！！
            string  TodayTimeStart=    DateTime.ToString("yyyy-MM-dd 00:00:00");  //今天零点
            DateTime dateTime2 = DateTime + new TimeSpan(1, 0, 0, 0);
            string TodayTimeEnd= dateTime2.ToString("yyyy-MM-dd 00:00:00");  //今天24点
            ...
            try
                ...
                if (dic !=null)
                {
                    //判断是否增加商品筛选
                    string goodsName = "";
                    if (dic.TryGetValue("TodaySearchGoodsName", out goodsName))  //是否包含TodaySearchGoodsName
                    {
                        sql += @" and goods." + "GoodsName" + " like '%" + goodsName + "%'";
                    ...
                    //判断是否增加价格筛选
                    if (dic.TryGetValue("TodaySearchMixMoney", out string  mixMoneyString)) //是否包含TodaySearchMixMoney
                    {
